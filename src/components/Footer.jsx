        ...
        <footer className="bg-black text-white pt-20 pb-5">
            <div className="lg:flex flex-row justify-center hidden gap-18">
                <div className="flex flex-col">
                    ...
                    <Link to="/Copa" className="font-medium">Copa Passa a Bola</Link>
                    <Link to="/Copa" className="font-medium">Calendário & Jogos</Link>
                    <Link to="/Copa/tabela" className="font-medium">Times & Jogadoras</Link>
