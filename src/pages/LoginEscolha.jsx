    ...
    return(
        <div className="flex flex-col justify-center items-center h-screen">
            ...
            <div className="flex flex-col gap-10">
                ...
                hover:border-[#3C1A6E] hover:bg-white hover:text-[#3C1A6E] hover:transition-all hover:duration-300">Sou uma atleta!</Link></button>
                <button><Link to="/login/time" className="border-2 border-[#EE4D9A] bg-[#EE4D9A] text-xl p-3 pl-[130px] pr-[130px] mt-[200px] text-white
                 hover:border-[#3C1A6E] hover:bg-white hover:text-[#3C1A6E] hover:transition-all hover:duration-300">Sou um time!</Link></button>
