    ...
    return (
        <div className="flex flex-col">
            <div className="flex border-2 border-b-[#3C1A6E] border-t-white border-r-white border-l-white w-240 gap-5">
                ...
                <Link to="/dashboard/clube/candidatas" className=" font-bold border-3 border-b-[#EE4D9A] border-t-white border-r-white border-l-white p-2">Pedidos</Link>
            </div>
            <div>
                            ...
                            {time.candidatas.map((candidata) => (
                                <div key={candidata.id} className=" border-2 border-[#3C1A6E] pl-7 pb-5 mt-5 mb-5 flex justify-between items-center border-b-[#3C1A6E] border-t-white border-r-white border-l-white">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div>
                                                <h2 className="text-[25px] font-bold uppercase">{candidata.nome} {candidata.sobrenome}</h2>
