  ...
  return (
    <div>
        ...
        <div className="flex lg:hidden justify-center items-center mb-15">
          <div className="bg-gradient-to-b from-[#3C1A6E] to-purple-600 w-110 text-white flex flex-col items-center  rounded-2xl">
            ...
            <div className="grid grid-cols-5 gap-6 mt-10 w-full p-5">
              ...
              <div className="flex flex-col justify-between space-y-20">
                <img src={time1?.foto || Placeholder} className="w-100 rounded-xl border-[#3C1A6E] border-2" />
                <img src={time2?.foto || Placeholder} className="w-100 rounded-xl border-[#3C1A6E] border-2" />
                <img src={time3?.foto || Placeholder} className="w-100 rounded-xl border-[#3C1A6E] border-2" />
                <img src={time4?.foto || Placeholder} className="w-100 rounded-xl border-[#3C1A6E] border-2" />
              </div>

              <div className="flex flex-col justify-around gap-10">
                <img src={Placeholder} className="w-20 rounded-xl border-[#3C1A6E] border-2" />
                <img src={Placeholder} className="w-20 rounded-xl border-[#3C1A6E] border-2" />
              </div>

              <div className="flex justify-center ">
                  <div className="bg-[#3C1A6E] text-white rounded-xl border-[#3C1A6E] border-2 shadow-lg flex flex-col items-center justify-center gap-6">
              ...
              <div className="flex flex-col justify-between space-y-20 items-end">
                <img src={time5?.foto || Placeholder} className="w-100 rounded-xl border-[#3C1A6E] border-2" />
                <img src={time6?.foto || Placeholder} className="w-100 rounded-xl border-[#3C1A6E] border-2" />
                <img src={time7?.foto || Placeholder} className="w-100 rounded-xl border-[#3C1A6E] border-2" />
                <img src={time8?.foto || Placeholder} className="w-100 rounded-xl border-[#3C1A6E] border-2" />
              </div>
            </div>
