    ...
    return (
         <div className="flex flex-col justify-center items-center h-screen">
            ...
            <div className="flex flex-col gap-10">
                ...
                hover:border-[#EE4D9A] hover:bg-white hover:text-[#EE4D9A] hover:transition-all hover:duration-300">Sou uma atleta!</Link></button>
                <button><Link to="/cadastrar/time" className="border-2 border-[#3C1A6E] bg-[#3C1A6E] text-xl p-3 pl-[130px] pr-[130px] mt-[200px] text-white
                 hover:border-[#EE4D9A] hover:bg-white hover:text-[#EE4D9A] hover:transition-all hover:duration-300">Sou um time!</Link></button>
