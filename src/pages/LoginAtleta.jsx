...
export default function LoginAtleta () {
    ...
    const handleSubmit = (e) => {
        ...
        if (user) {
            ...
            navigate("login/jogadora/dashboard");
        } else {
    ...
    return(
        <div className="flex h-screen justify-center items-center bg-[#EE4D9A]">
            <form className="flex flex-col gap-3 items-center"
                ...
                <div>
                    <p className="text-white text-[20px]">Não tem conta?<Link to={"/cadastrar/atleta"} className="text-[#3C1A6E] font-medium"> Registre-se</Link></p>
                </div>
